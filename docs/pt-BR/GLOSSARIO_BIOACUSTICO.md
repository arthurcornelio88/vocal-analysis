...
| VMI | Label | Descrição |
|-----|-------|-----------|
| 0.0-0.2 | M1_HEAVY | Voz de peito plena, adução firme |
| 0.2-0.4 | M1_LIGHT | M1 mais leve, borda fina |
| 0.4-0.6 | MIX_PASSAGGIO | Zona de passagem, voz mista |
| 0.6-0.8 | M2_REINFORCED | M2 com adução glótica, belting leve |
| 0.8-1.0 | M2_LIGHT | Falsete, mecanismo leve |
...
3. `outputs/analysis_report.md` — resultados concretos
