...
**Last updated:** 2026-02-09 (post-correction pass)
...
15. [henrich2004 — Henrich et al. (2004)](#15-henrich2004)
16. [bozeman2013 — Bozeman (2013)](#16-bozeman2013)
17. [sundberg1987 — Sundberg (1987)](#17-sundberg1987)
18. [kim2018 — Kim et al. (2018)](#18-kim2018)
19. [boersma2023 — Boersma & Weenink (2023)](#19-boersma2023)
20. [maryn2015 — Maryn & Weenink (2015)](#20-maryn2015)
21. [teixeira2013 — Teixeira, Oliveira & Lopes (2013)](#21-teixeira2013)
22. [sundberg2006 — Sundberg & Nordenberg (2006)](#22-sundberg2006)
23. [hanson1997 — Hanson (1997)](#23-hanson1997)
24. [kreiman2014 — Kreiman et al. (2014)](#24-kreiman2014)
25. [fant1995 — Fant (1995)](#25-fant1995)
26. [gauffin1989 — Gauffin & Sundberg (1989)](#26-gauffin1989)
27. [chen2016 — Chen & Guestrin (2016)](#27-chen2016)
28. [lee2013 — Lee (2013)](#28-lee2013)
29. [nigam2000 — Nigam et al. (2000)](#29-nigam2000)
30. [ghasemzadeh2023 — Ghasemzadeh, Hillman & Mehta (2023)](#30-ghasemzadeh2023)
31. [nudelman2025 — Nudelman et al. (2025)](#31-nudelman2025)
32. [behlau1988 — Behlau & Ziemer (1988)](#32-behlau1988)
...
> "...confirming the physiological basis of the G4 passaggio boundary for female voices documented in the literature."
...
**Assessment:** Cotton's DMA dissertation specifically examines Fach classification and its inconsistencies. Appropriate citation for the claim about the system's dominance and origins.
...
**Assessment:** CORRECTED. Author list fixed from 4 authors (Defossez, Usunier, Bottou, Bach) to single author (Défossez). The 2021 paper introduces the Hybrid Demucs concept (hybrid spectrogram + waveform). Now cited alongside rouard2023 for the Transformer-enhanced version (HTDemucs) actually used in the pipeline.
...
**Claim supported:** ML (specifically XGBoost) has been applied to vocal mode classification in singing voice.
**Assessment:** CORRECTED. Previously cited as "schulze2023" with wrong author (Schulze → Sol), wrong venue (ResearchGate preprint → J Voice), and wrong genre description ("operatic singing" → "singing voice classification"). Sol et al. (2023) uses the Complete Vocal Technique (CVT) framework for vocal mode classification in healthy singing voice, not operatic singing specifically. Text updated accordingly.
...
**Assessment:** This is the seminal paper on the singer's formant. Sundberg (1974) is the canonical reference for this phenomenon. The frequency range and formant convergence description are well-established. [VERIFY: confirm the exact frequency range stated (2.5-3.5 kHz) matches Sundberg's figures — some sources cite 2-4 kHz or 2.5-3.0 kHz]
...
**Assessment:** Bourne & Garnier (2012) study female music theatre voice, which is also a microphone-dependent genre. [VERIFY: confirm the paper discusses the role of amplification in music theatre and how it changes vocal quality expectations compared to operatic singing]
...
**Assessment:** Bourne & Garnier (2012) examines multiple vocal qualities in music theatre including belt and mix. [VERIFY: confirm the paper specifically discusses the concept of a "mixing zone" and vocal tract adjustments for belting]
...
**Full reference:**
Henrich N, d'Alessandro C, Doval B, Castellengo M. Glottal open quotient in singing: measurements and correlation with laryngeal mechanisms, vocal intensity, and fundamental frequency. *J Acoust Soc Am*. 2004;117(3):1417-1430. doi:10.1121/1.1850031

**Occurrences in article (4):**

### Occurrence 1 (line 215) — Theoretical Framework §2.2
> "M1 generates rich harmonic spectra with high spectral energy in low harmonics, typically elevated harmonicity-to-noise ratio (HNR), and strong acoustic projection."

**Claim supported:** Acoustic characteristics of M1 (rich harmonics, high HNR, strong projection).
**Assessment:** Henrich et al. (2004) used EGG to study open quotient and its correlation with laryngeal mechanisms. The paper's focus is on glottal open quotient; the spectral characteristics described may be inferred from the OQ data. [VERIFY: HNR and spectral energy claims may not be explicitly stated in these terms — the paper focuses on OQ]
...
**Assessment:** This is the original CREPE paper. Correct description and citation. Well-established tool.
...
**Assessment:** Maryn & Weenink (2015) is the reference paper for CPPS implementation in Praat. Correct citation.
...
### Occurrence 1 (line 315) — Methods §3.3
> "Jitter (ppq5), and Shimmer (apq11)."

**Claim supported:** Jitter and shimmer as voice quality parameters.
**Assessment:** Teixeira et al. (2013) reviews jitter, shimmer, and HNR. Appropriate reference for these acoustic parameters.
...
### Occurrence 1 (line 323) — Methods §3.3
> "Alpha Ratio: the energy ratio (dB) between the high band (1-5 kHz) and the low band (50 Hz-1 kHz). In M1, rapid and firm glottal closure generates strong upper harmonics, producing a high Alpha Ratio. In M2/falsetto, gentle closure concentrates energy in the fundamental, yielding a low ratio."

**Claim supported:** Alpha Ratio definition and its physiological interpretation regarding glottal closure.
**Assessment:** VERIFIED. Sundberg & Nordenberg (2006) defines "the alpha measure" as the ratio of energy above and below 1 kHz in LTAS. The 1000 Hz split point is confirmed correct. Our exact band limits (50 Hz lower bound, 5 kHz upper bound) are implementation-specific but defensible as standard spectral analysis bounds. The M1/M2 interpretation (glottal closure → spectral balance) is an extrapolation from Sundberg's concept but is physiologically grounded. No change needed.
...
**Claim supported:** H₁-H₂ as correlate of glottal adduction (supporting citation alongside hanson1997).
**Assessment:** Kreiman et al. (2014) reviews voice production and perception, including spectral measures of voice quality. [VERIFY: confirm the paper discusses H₁-H₂ specifically as a glottal adduction correlate]
...
**Full reference:**
Fant G. The LF-model revisited: transformations and frequency domain analysis. *STL-QPSR*. 1995;2-3:119-156.

**Occurrences in article (2):**

### Occurrence 1 (line 337) — Methods §3.3
...
**Assessment:** Fant (1995) discusses the LF-model of glottal flow, which is directly related to spectral tilt. The LF-model parameters determine the spectral envelope slope. Appropriate foundational citation.

### Occurrence 2 (line 778) — Discussion §5.2
...
**Assessment:** The LF-model describes glottal behavior independently of f₀. [VERIFY: confirm that this frequency-independence claim is supported or can be inferred from Fant's LF-model description]
...
**Full reference:**
Gauffin J, Sundberg J. Spectral correlates of glottal voice source waveform characteristics. *J Speech Hear Res*. 1989;32(3):556-565. doi:10.1044/jshr.3203.556
...
**Claim supported:** Spectral correlates of glottal waveform characteristics (supporting citation alongside fant1995).
**Assessment:** Gauffin & Sundberg (1989) directly studies the spectral consequences of different glottal waveforms. Appropriate citation for spectral tilt interpretation.

### Occurrence 2 (line 778) — Discussion §5.2
> Same passage as fant1995 Occurrence 2.

**Claim supported:** Same as above.
**Assessment:** Appropriate supporting citation.
...
**Assessment:** Lee (2013) is the foundational paper on pseudo-labels. Correct citation.
...
**Assessment:** This is a well-known limitation of pseudo-labeling discussed in Lee (2013) and the broader semi-supervised literature. Appropriate citation.
...
### Occurrence 1 (line 382) — Methods §3.4
> "We acknowledge that results are reported for a single random seed. Per the methodological recommendations of Ghasemzadeh et al. [...] future work should evaluate performance across multiple seeds and report mean ± standard deviation."

**Claim supported:** Best practice recommendation for multi-seed evaluation and reporting mean±SD.
**Assessment:** This paper is specifically about generalizable ML in speech/language/hearing. [VERIFY: confirm the paper specifically recommends multi-seed evaluation with mean±SD reporting]

### Occurrence 2 (line 405) — Methods §3.5
> "...in accordance with current best practices for machine learning in voice research..."

**Claim supported:** General reference to ML best practices in voice research.
**Assessment:** Appropriate as a methodological guideline citation.

### Occurrence 3 (line 823) — Discussion §5.3
> Repeat of the single random seed limitation with recommendation.

**Claim supported:** Same as Occurrence 1.
**Assessment:** Same verification needed.

### Occurrence 4 (line 882) — Conclusion
> "...model stability should be evaluated across multiple random seeds, with mean ± standard deviation of classification metrics reported per current best practices."

**Claim supported:** Same recommendation, in future work context.
...
**Full reference:**
Nudelman CJ, et al. Machine learning in voice: a field-specific review of applications, challenges, and recommendations. *J Voice*. 2025. doi:10.1016/j.jvoice.2024.11.030

**Occurrences in article (4):**

### Occurrence 1 (line 383) — Methods §3.4
> "...and Nudelman et al., future work should evaluate performance across multiple seeds and report mean ± standard deviation."

**Claim supported:** ML methodology recommendations for voice research.
**Assessment:** This is a JoV-specific ML review paper. [VERIFY: confirm the paper makes specific recommendations about multi-seed evaluation and reporting]

### Occurrence 2 (line 405) — Methods §3.5
> "...in accordance with current best practices for machine learning in voice research..."

**Claim supported:** General ML best practices citation.
**Assessment:** Appropriate as a JoV-targeted methodological reference.

### Occurrence 3 (line 824) — Discussion §5.3
> Same passage as ghasemzadeh2023 Occurrence 3.

**Claim supported:** Same multi-seed recommendation.
**Assessment:** Same verification needed.

### Occurrence 4 (line 882) — Conclusion
> Same passage as ghasemzadeh2023 Occurrence 4.

**Claim supported:** Same recommendation in future work.
**Assessment:** Same as above.
...
| 2 | sundberg2006 | Alpha Ratio band boundaries (50 Hz-1 kHz vs 1-5 kHz) may differ from original | HIGH | **RESOLVED** — Verified: 1000 Hz split confirmed correct; exact band limits are implementation-specific but defensible. No change needed |
...
| 6 | schulze2023 | Wrong author (Schulze → Sol), wrong venue (ResearchGate → J Voice), wrong genre (operatic → CVT) | MEDIUM | **RESOLVED** — Renamed to sol2023 with correct author (Sol et al.), venue (J Voice), DOI. Text changed from "operatic singing" to "singing voice classification" |
